...
const Sidebar = () => {
    ...
    return (
        ...
        <div className="w-64 h-screen bg-gray-800 text-white flex flex-col p-4 shadow-lg fixed left-0 top-0 font-bold font-[Poppins]">
            <div className="pb-4 mb-8 text-2xl font-bold text-center border-b border-gray-700">
                FoundIt Admin
            </div>
            <nav className="flex flex-col space-y-4">
                <Link to="/Dashboard" className="flex items-center p-2 space-x-3 transition duration-200 rounded-lg hover:bg-gray-700">
                ...
                <Link to="/admin/items" className="flex items-center p-2 space-x-3 transition duration-200 rounded-lg hover:bg-gray-700">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                    <span>Items</span>
                </Link>
                <Link to="/admin/users" className="flex items-center p-2 space-x-3 transition duration-200 rounded-lg hover:bg-gray-700">
                ...
                <Link to="/admin/claims" className="flex items-center p-2 space-x-3 transition duration-200 rounded-lg hover:bg-gray-700">
                ...
                <button
                    ...
                    className="flex items-center p-2 mt-auto space-x-3 transition duration-200 rounded-lg hover:bg-gray-700"
                >
